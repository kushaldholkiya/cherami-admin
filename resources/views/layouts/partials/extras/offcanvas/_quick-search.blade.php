                    ...
                    <div class="mb-10">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                <img src="{{ asset('media/svg/files/doc.svg') }}" alt="{{ config('app.name') }}"/>
                            </div>
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                <img src="{{ asset('media/svg/files/pdf.svg') }}" alt="{{ config('app.name') }}"/>
                            </div>
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                <img src="{{ asset('media/svg/files/xml.svg') }}" alt="{{ config('app.name') }}"/>
                            </div>
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">
                                All Framework Docs
                        ...
                        <div class="d-flex align-items-center flex-grow-1 mb-2">
                            <div class="symbol symbol-30 bg-transparent flex-shrink-0">
                                <img src="{{ asset('media/svg/files/csv.svg') }}" alt="{{ config('app.name') }}"/>
                            </div>
                            <div class="d-flex flex-column ml-3 mt-2 mb-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">
